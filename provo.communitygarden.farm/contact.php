			...
			<div class="slider">		
                    ...
                    <div class="controls">
                        ...
                        <div class="banner">
                            ...
                            <strong>
                            	<span class="text-1">Volunteer/s & Community Service</span>
						...
						<div class="banner">
                            ...
                            <strong>
                            	<span class="text-1">Pledge & Monetary Donations</span>
                                <span class="text-2"></span>
                            </strong>
                        </div>
		...
		<td align="center" class="bgcolor">
			<div id="main">
					<div class="contact">
						<div class="section">
							<div class="heading">
								Get in touch with the Provo Community Garden! 801.930.0675
							</div>
							<p>
						...
						<div class="section">
							<table border="1" width="60%">
								...
								<tr>
									<td width="80%">
										<input type="text" placeholder="How close to Provo garden are you?" id="in">
									</td>
								</tr>
								<tr>
									<td width="80%">
